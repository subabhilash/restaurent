      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start mb-3">
              ...
              <span className="text-zinc-400">All Days: 1:00 PM - 11:30 PM</span>
            </div>
          </div>
          
          <div className="text-center">
            <h3 className="text-xl font-serif text-amber-400 mb-4">MAHARAJA RESTO BAR</h3>
            <p className="text-zinc-400 mb-4">Family Garden Restaurant</p>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-end mb-3">
              ...
              <span className="text-zinc-400">Shamanur Road, Devarabelakere, Shamanur Karnataka 577004</span>
            </div>
            <div className="flex items-center justify-center md:justify-end">
              <Phone className="h-4 w-4 text-amber-500 mr-2" />
              <span className="text-zinc-400">+91 93801 18824</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-zinc-800 pt-8 text-center">
          <p className="text-zinc-500 text-sm">
            &copy; {new Date().getFullYear()} MAHARAJA RESTO BAR. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
